...
#
# def test_profitable_change_debt(accounts, providerA, providerB, tokenA, tokenB, amountA, amountB, vaultA, vaultB, rebalancer,
#                                 user, gov,
...
#
#     util.stateOfStrat("harvest at 5000", rebalancer, providerA, providerB)
#     util.simulate_2_sided_trades(rebalancer, tokenA, tokenB, providerA, providerB, rando, accounts)
#
#     vaultA.updateStrategyDebtRatio(providerA.address, 10_000, {"from": gov})
#     chain.sleep(1)
#
