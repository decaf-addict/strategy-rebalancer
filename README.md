...
- Basic Solidity Smart Contract for creating your own Yearn Strategy ([`contracts/Strategy.sol`](contracts/JointProvider.sol))
...
3. Deploy the [`Strategy.sol`](contracts/JointProvider.sol) contract.
...
[`contracts/Strategy.sol`](contracts/JointProvider.sol) is where you implement your own logic for your strategy. In particular:
...
The example tests provided in this mix start by deploying and approving your [`Strategy.sol`](contracts/JointProvider.sol) contract. This ensures that the loan executes succesfully without any custom logic. Once you have built your own logic, you should edit [`tests/test_flashloan.py`](tests/test_flashloan.py) and remove this initial funding logic.
